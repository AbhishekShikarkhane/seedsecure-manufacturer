              ...
              {batch.parentCartonID ? (
                <>
                  ...
                  <div style={{ background: '#f7f8fa', padding: 16, borderRadius: 8, marginBottom: 12, display: 'inline-block' }}>
                    <QRCodeCanvas value={`https://seedsecure-farmer-426y8cny5-abhisheks-projects-7717ae06.vercel.app/scan?id=${batch.parentCartonID}`} size={160} level="H" includeMargin={true} />
                  </div>
                  {/* Compact hash pill */}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ background: '#f7f8fa', padding: 8, borderRadius: 8, marginBottom: 6 }}>
                          <QRCodeCanvas value={`https://seedsecure-farmer-426y8cny5-abhisheks-projects-7717ae06.vercel.app/verify?id=${childId}`} size={64} level="M" />
                        </div>
